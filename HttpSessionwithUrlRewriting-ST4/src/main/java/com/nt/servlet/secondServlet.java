...
public class secondServlet extends HttpServlet {
	...
	//	res.sendRedirect("http://localhost:8086/HttpSessionwithUrlRewriting-ST4/");
		
		  //print form data
		  pw.println("<b style='text-align:center;color:red'>Form 1 data :"+name+" "
		  +addrs+" "+ms+"</b>");
		  pw.println("<br><br><b style='text-align:center;color:red'>Form 2 data :"
		  +f2t1+" "+f2t2+"</b>");
